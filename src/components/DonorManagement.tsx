...
export const DonorManagement = () => {
      ...
      const donorsWithProfiles = await Promise.all(
        donorData.map(async (donor) => {
          ...
          return {
            ...
            age: typeof donor.medical_history === 'object' && donor.medical_history !== null ? 
              (donor.medical_history as any)?.age : undefined,
  ...
  const addDonor = useMutation({
    mutationFn: async (donor: any) => {
      // First create a profile with UUID generated by Supabase
